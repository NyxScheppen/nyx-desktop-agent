...
| `nyx` | `reading_association` | 左气泡，带「联想」徽标 +「记忆」标，即时全量 | 读书联想并进对话（不逐字，不进打字机） |
